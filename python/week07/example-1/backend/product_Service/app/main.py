# week07/example-1/backend/product_service/app/main.py
...
# Keeping your existing detailed logging format
logging.basicConfig(
    level=logging.INFO,
...
# Define Prometheus metrics (Basic HTTP Metrics Only for Example 1)
...
async def startup_event():
    ...
    for i in range(max_retries):
        try:
            ...
            # No initial gauge population for stock levels in Example 1
