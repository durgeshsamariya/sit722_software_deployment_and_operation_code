# week02/example-1/product_service/tests/test_main.py
...
def setup_database_for_tests():
    ...
    Explicitly drops all tables before creating them to ensure a truly
...
def test_update_product_full(client: TestClient, db_session_for_test: Session):
    """
