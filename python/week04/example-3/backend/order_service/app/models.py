# week04/example-3/backend/order_service/app/models.py
...
class Order(Base):
    __tablename__ = "orders_week04_example_03"
...
class OrderItem(Base):
    __tablename__ = "order_items_week04_example_03"

    order_item_id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    order_id = Column(
        Integer,
        ForeignKey("orders_week04_example_03.order_id"),
        nullable=False,
        index=True,
    )
