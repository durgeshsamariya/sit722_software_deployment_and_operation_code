...
class Order(Base):
    ...
    __tablename__ = "orders_week03_part_01"
...
class OrderItem(Base):
    ...
    """
    __tablename__ = "order_items_week03_part_01" # Unique table name for this example

    order_item_id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    
    # Foreign key to the 'orders' table
    order_id = Column(Integer, ForeignKey("orders_week03_part_01.order_id"), nullable=False, index=True)
